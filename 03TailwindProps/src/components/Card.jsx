import React from 'react'
 ...
 function Card ({username="Aryan", btn="click Baby"}) { // props is used the word defined by the react itself 
console.log("props",username); // so this username = "Aryan" and btn = "click Baby" are default value , that means
// if you didnt pass any value then it will pass this value 
